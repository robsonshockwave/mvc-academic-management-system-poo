...
class InsereAlunoView(tk.Toplevel):
    ...
    def __init__(self, control, cursosList):
        ...
        # Cria o título
        self.title("CADASTRO DE ALUNO/ INSIRA")
        # Controle
        ...
        self.buttonInserir = tk.Button(self.frameButton, text='INSERIR', font=('Negrito', 11))
...
class CtrlAluno():
    ...
    def insereHandler(self, event):
        ...
        # Mostra mensagem avisando o usuário sobre o erro
            ...
            self.limiteIns.mostraJanela("AVISO!", "NOME OU NÚMERO DE MATRICULA JÁ EXISTE")
        # Mostra mensagem avisando o usuário sobre o erro
        except InvalidName:
            self.limiteIns.mostraJanela("AVISO!", "NOME INVÁLIDO! EXEMPLO: ROBSON ARRUDA")
        # Mostra mensagem avisando o usuário sobre o erro
        ...
        # Caso não tenha erros das exeptions acima
            ...
            self.limiteIns.mostraJanela('CONGRULATIONS!', 'ALUNO CADASTRADO')
    ...
    def clearHandler(self, event):
        ...
        self.limiteIns.inputCursoAluno.delete(0, len(self.limiteIns.inputCursoAluno.get()))
