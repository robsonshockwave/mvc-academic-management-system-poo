...
class InsereDisciplinaView(tk.Toplevel):
    ...
    def __init__(self, control):
        ...
        # Cria o título
        self.title('CADASTRO DE DISCIPLINA/ INSIRA')
        # Controle
        ...
        self.labelCargaH = tk.Label(self.frameCargaH, text='CARGA TOTAL:')
        ...
        self.buttonClear = tk.Button(
            self.frameButton, text='LIMPAR', font=('Negrito', 11))
        ...
        self.buttonConcluido = tk.Button(
            self.frameButton, text='FECHAR', font=('Negrito', 11))
...
class CtrlDisciplina():
    ...
    def insereHandler(self, event):
        ...
        # Mostra mensagem avisando o usuário sobre o erro
            ...
            self.limiteIns.mostraJanela('AVISO!', "NOME OU CÓDIGO DA DISCIPLINA JÁ EXISTE")
        # Mostra mensagem avisando o usuário sobre o erro
        except InvalidName:
            self.limiteIns.mostraJanela("AVISO!", "NOME INVÁLIDO! EXEMPLO: PASTAGENS RURAIS")
        # Mostra mensagem avisando o usuário sobre o erro
        except InvalidCode:
            self.limiteIns.mostraJanela("AVISO!", "CÓDIGO INVÁLIDO! EXEMPLO: GEO123")
    ...
    def clearHandler(self, event):
        self.limiteIns.inputCodigoDisciplina.delete(0, len(self.limiteIns.inputCodigoDisciplina.get()))
        self.limiteIns.InputNomeDisciplina.delete(0, len(self.limiteIns.InputNomeDisciplina.get()))
        self.limiteIns.comboboxCargaH.delete(0, len(self.limiteIns.comboboxCargaH.get()))
