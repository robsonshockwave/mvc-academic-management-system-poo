...
class InsereCursosView(tk.Toplevel):
    ...
    def __init__(self, control, gradesList):
        ...
        # Cria o título
        self.title('CADASTRO DE CURSO/ INSIRA')
        # Controle
...
class CtrlCurso():
    ...
    def insereHandler(self, event):
        ...
        # Mostra mensagem avisando o usuário sobre o erro
            ...
            self.limiteIns.mostraJanela('AVISO!', 'NOME OU CÓDIGO JÁ EXISTE')
        # Mostra mensagem avisando o usuário sobre o erro
        except InvalidName:
            self.limiteIns.mostraJanela("AVISO", "NOME INVÁLIDO! EXEMPLO: GEOGRAFIA")
        # Mostra mensagem avisando o usuário sobre o erro
        except InvalidCode:
            self.limiteIns.mostraJanela("AVISO!", "CÓDIGO INVÁLIDO! EXEMPLO: GEO")
        # Caso não tenha erros das exeptions acima
            ...
            self.limiteIns.mostraJanela('CONGRULATIONS!', 'CURSO CADASTRADO')
            ...
            for curso in self.cursosList:
                ...
                for grade in gradesList:
                    if grade.getCodigoGrade() == curso.getGrade():
                        str += "GRADE ~~ ANO E SEMESTRE DO ANO\n"
